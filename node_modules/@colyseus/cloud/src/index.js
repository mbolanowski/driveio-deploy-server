...
Options:
  ...
  --applicationId   Use a specific applicationId (You can find it from your .colyseus-cloud.json file)
  --token           Use a specific token (You can find it from your .colyseus-cloud.json file)

  (debugging)
  --dry-run         Do not perform deployment, only output variables for debugging purposes.
